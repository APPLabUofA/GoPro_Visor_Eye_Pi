...
for par in range(1,par_num+2):
    if par != 2:
        if par > 2:
            globals()["df_" + str(par-1)] = pd.read_csv((r'M:\Data\GoPro_Visor\Experiment_1\Video_Times\Dataframe_df3_whole_final_00' + str(par)) + '.csv', sep=',') # pilot

        else:
            globals()["df_" + str(par)] = pd.read_csv((r'M:\Data\GoPro_Visor\Experiment_1\Video_Times\Dataframe_df3_whole_final_00' + str(par)) + '.csv', sep=',') # pilot
...
[ax[0][i].set_xlabel("ms") for i in range(0, 2)]
[ax[0][i].set_ylabel("Trial Ratio") for i in range(0, 2)]
...
[ax[1][i].set_xlabel("ms") for i in range(0, 2)]
[ax[1][i].set_ylabel("Trial Ratio") for i in range(0, 2)]
