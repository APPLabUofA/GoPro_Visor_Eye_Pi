...
par = 8 # number 7 blue flashes are completely undetectable, number 8 has indestinguishable blue flashes (more red in them than blue)
Vid_Num = 1
in_format = '.avi'
...
col = ['green','blue','red']
b_w8 = [0,1.2,0,1.4,1.5,1,1.6,1.3,1.4]
g_w8 = [0,7,0,7,7,7,9,8,7.5]
r_w8 = [0,1.2,0,1.4,1.3,1,1.35,1.3,1.4,1.05]
...
out = cv2.VideoWriter(out_file,fourcc, 240, (424,240))
...
if Vid_Num == 1:
    ...
    df1a = df1
    export_csv = df1a.to_csv (r'M:\Data\GoPro_Visor\Experiment_1\Video_Times\Dataframe_df1a_Vid_1_00' + str(par) + '.csv', index = None, header=True) #Don't forget to add '.csv' at the end of the path
